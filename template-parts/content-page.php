							...
							<div class="col-xl-10 mt_30">
									...
									<div class="owl-carousel client_carousel">
											<div class="item d-flex align-items-center justify-content-center">
												 <img src="<?php echo get_template_directory_uri() ?>/img/client_1.png" class="img-fluid" alt="">         
											</div>
											<div class="item d-flex align-items-center justify-content-center">
													<img src="<?php echo get_template_directory_uri() ?>/img/client_2.png" class="img-fluid" alt="">
											</div>
											<div class="item d-flex align-items-center justify-content-center">
													<img src="<?php echo get_template_directory_uri() ?>/img/client_3.png" class="img-fluid" alt="">
											</div>
											<div class="item d-flex align-items-center justify-content-center">
													<img src="<?php echo get_template_directory_uri() ?>/img/client_4.png" class="img-fluid" alt="">
											</div>
											<div class="item d-flex align-items-center justify-content-center">
													<img src="<?php echo get_template_directory_uri() ?>/img/client_5.png" class="img-fluid" alt="">
											</div>
									</div>
							</div>
					</div>
					...
					<div class="row align-items-center">
							<div class="col-lg-7 col-md-5 mt_30">
									<div class="awesomeapp_img">
											<img src="<?php echo get_template_directory_uri() ?>/img/app_feature.png" class="img-fluid" alt="">
									</div>
							</div>
									...
									<div>
											...
											<div class="app_item d-flex align-items-center">
													<div class="appimg_bg appimg_bg1">
															<img src="<?php echo get_template_directory_uri() ?>/img/app_icon1.png" class="img-fluid" alt="">
													</div>
											...
											<div class="app_item d-flex align-items-center">
													<div class="appimg_bg appimg_bg2">
															<img src="<?php echo get_template_directory_uri() ?>/img/app_icon2.png" class="img-fluid" alt="">
													</div>
													<div class="app_subitem">
											...
											<div class="app_item d-flex align-items-center">
													<div class="appimg_bg appimg_bg3">
															<img src="<?php echo get_template_directory_uri() ?>/img/app_icon3.png" class="img-fluid" alt="">
													</div>
													<div class="app_subitem">
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
									<div class="smartjact_item">
											<div class="appimg_bg appimg_bg1 mb_30">
													<img src="<?php echo get_template_directory_uri() ?>/img/smartjack_icon1.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
									<div class="smartjact_item">
											<div class="appimg_bg appimg_bg2 mb_30">
													<img src="<?php echo get_template_directory_uri() ?>/img/smartjact_icon2.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
									<div class="smartjact_item">
											<div class="appimg_bg appimg_bg3 mb_30">
													<img src="<?php echo get_template_directory_uri() ?>/img/smartjact_icon3.png" class="img-fluid" alt="">
											</div>
					...
					<div class="row align-items-center">
							<div class="col-lg-6 col-md-6 order-sm-last order-md-first mt_30">
									<div class="desingbuild_img">
											<img src="<?php echo get_template_directory_uri() ?>/img/design&build_img.png" class="img-fluid" alt="">
									</div>
							</div>
					...
					<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg1">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon1.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg4">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon2.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg5">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon3.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg3">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon4.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg2">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon5.png" class="img-fluid" alt="">
											</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6 text-center mt_30">
									<div class="chooseapp_item">
											<div class="appimg_bg appimg_bg6">
													<img src="<?php echo get_template_directory_uri() ?>/img/chooseapp_icon6.png" class="img-fluid" alt="">
											</div>
					...
					<div class="row align-items-center justify-content-center justify-content-lg-start">
							<div class="col-lg-7 col-md-12 mt_30">
									...
									<div class="row">
											<div class="col-lg-6 col-md-6 col-sm-6">
													<div class="smartjact_item">
															<div class="appimg_bg appimg_bg1 mb_30">
																	<img src="<?php echo get_template_directory_uri() ?>/img/ultimate_icon1.png" class="img-fluid" alt="">
															</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
													<div class="smartjact_item">
															<div class="appimg_bg appimg_bg3 mb_30">
																	<img src="<?php echo get_template_directory_uri() ?>/img/ultimate_icon2.png" class="img-fluid" alt="">
															</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
													<div class="smartjact_item">
															<div class="appimg_bg appimg_bg2 mb_30">
																	<img src="<?php echo get_template_directory_uri() ?>/img/ultimate_icon4.png" class="img-fluid" alt="">
															</div>
							...
							<div class="col-lg-5 col-md-9 mt_30 ultimate_ab">
									<div class="ultimate_image">
											<img src="<?php echo get_template_directory_uri() ?>/img/ultimate_feature_img.png" class="img-fluid" alt="">
									</div>
							</div>
					</div>
			</div>
									...
									<nav class="text-center">
										...
										<div class="tab-content" id="nav-tabContent">
											<div class="tab-pane fade show active" id="nav-home" role="tabpanel">
													<div class="row">
															<div class="col-lg-4 col-md-6 offset-md-2 mt_30 text-center">
					...
					<div class="row align-items-center justify-content-end">
							<div class="col-lg-6 mt_30 meetimg_ab">
									<div class="meetclient_img">
											<img src="<?php echo get_template_directory_uri() ?>/img/meet_client.png" class="img-fluid" alt="">
									</div>
							</div>
											...
											<div class="owl-carousel testi_slide">
													<div class="friendcustomize_box">
															...
															<div class="meet_man d-flex align-items-center">
																	<img src="<?php echo get_template_directory_uri() ?>/img/meet_img.png" class="meet_size" alt="">
																	<div class="meet_txt">
																			<h4>Zoltan Nemeth</h4>
							...
							<div class="col-lg-7 col-md-12 mt_30">
									<div class="download_box">
											...
											<div class="d-flex align-items-center flex-wrap">
													<a href="#"><img src="<?php echo get_template_directory_uri() ?>/img/google_play.png" class="img-fluid mr_30" alt=""></a>
													<a href="#"><img src="<?php echo get_template_directory_uri() ?>/img/apple_store.png" class="img-fluid" alt=""></a>
											</div>
									</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-12 download_ab">
									<div class="download_img">
											<img src="<?php echo get_template_directory_uri() ?>/img/download_img.png" class="img-fluid" alt="">
									</div>
							</div>
					</div>
			</div>
